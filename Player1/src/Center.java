...
public class Center extends JPanel {
	...
	/**
	 * handles opponentPlay reply to display on GUI
	...
	public void opponentPlay(String message) { //player, move (0-8), exit(1 exit, 0 no exit);
		...
		if (inbox[0].equals("2")) { // "2" means message is from opponent
			if (inbox[2].equals("-1")) {
	...
	public int checkGameStatus() {
		int result = -1; // 1 for player, 2 for computer win, 3 for draw
